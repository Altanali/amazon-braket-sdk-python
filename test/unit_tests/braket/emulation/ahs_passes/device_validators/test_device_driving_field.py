...
from braket.emulation.emulation_passes.ahs_passes.device_validators import (
...
def test_valid_device_driving_field(driving_field_data, non_local_capabilities_constants):
    try:
        DeviceDrivingFieldValidator(
